...
# ZSH_THEME_RANDOM_CANDIDATES=( "robbyrussell" "amuse" "crunch" "agnoster")
...
__conda_setup="$('/var/home/tobiasr/miniconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/var/home/tobiasr/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/var/home/tobiasr/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/var/home/tobiasr/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
